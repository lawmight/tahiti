...
| **Architecture plugin/tab** | Chaque module est indépendant et s'enregistre dans un registre central. Ajouter un module = ajouter un fichier + l'enregistrer. Aucun code existant ne doit être modifié. |
